...
export default function TravelersPage() {
  ...
  const selectedConversation = conversations.find((conversation) => `${conversation.propertyId}-${conversation.guestId}` === selectedGuestId) ?? conversations[0];
